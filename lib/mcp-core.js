...
const INSTRUCTIONS =
  ...
  'list everything. For a page with images, call `upload_image` for each image ' +
  'FIRST, then reference the returned path in the HTML (<img src="/<slug>/' +
  '<name>">) and publish — an uploaded image is served under the page\'s own ' +
  'access, so a restricted page keeps its images restricted. `list_images` ' +
  'and `delete_image` manage what a page already has.';
