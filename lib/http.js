...
// Reads the request body as raw bytes, for endpoints that accept a binary
// upload rather than JSON. Vercel hands some bodies over already parsed, so a
// Buffer or string body is used as-is instead of re-reading a consumed stream.
